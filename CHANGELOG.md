...
* **$server:** add client folder in .gitignore file ([d297112](https://github.com/CoachingCloud/automated-push-content/commit/d297112))
...
* **$server:** upgrade to Node 11 on Debian 9 to fix issue 'jessie package was removed on old Debian version' ([6658b06](https://github.com/CoachingCloud/automated-push-content/commit/6658b06))
...
* **$server:** validate tagged users to ensure these user_id exists in database ([69ef89c](https://github.com/CoachingCloud/automated-push-content/commit/69ef89c)), closes [#82](https://github.com/CoachingCloud/automated-push-content/issues/82)
...
* **$server:** Declare polymorphic relations between workbook model with library model and program model ([263f1a5](https://github.com/CoachingCloud/automated-push-content/commit/263f1a5)), closes [#83](https://github.com/CoachingCloud/automated-push-content/issues/83)
...
* **$server:** edit script to build docker file ([c9bcd4b](https://github.com/CoachingCloud/automated-push-content/commit/c9bcd4b))
