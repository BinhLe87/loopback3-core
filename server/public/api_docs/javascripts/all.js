  ...
  (function(e, t) {
    ...
    function j(e, t) {
      ...
      if (1 === t.nodeType) {
        ...
        He.hasData(e) &&
          ((a = He.access(e)), (u = ge.extend({}, a)), He.set(t, u));
      }
    }
    function A(e, t) {
    ...
    function I(e, t, n) {
      ...
      return at.test(o)
        ...
        : ((r = s && (pe.boxSizingReliable() || o === e.style[t])),
          ...
          (o = parseFloat(o) || 0),
          o + H(e, t, n || (s ? 'border' : 'content'), r, i) + 'px');
    }
 ...
 */ = (function(
      ...
      (T = t.support = {}),
        ...
        (t.attr = function(e, t) {
          ...
          var n = S.attrHandle[t.toLowerCase()],
            r =
              n && Q.call(S.attrHandle, t.toLowerCase()) ? n(e, t, !$) : void 0;
          return void 0 !== r
            ? r
            : T.attributes || !$
              ? e.getAttribute(t)
        ...
        function(e, t) {
          ge.fn[e] = function(n, r) {
            ...
            return (
              ...
              this.length > 1 &&
                (Le[e] || ge.uniqueSort(i), Ae.test(e) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
      ...
      ge.extend({
        ...
        ready: function(e) {
          (e === !0 ? --ge.readyWait : ge.isReady) ||
            ((ge.isReady = !0),
            (e !== !0 && --ge.readyWait > 0) || qe.resolveWith(ne, [ge]));
        }
      }),
      ...
      ge.fn.extend({
        data: function(e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((i = He.get(o)), 1 === o.nodeType && !Pe.get(o, 'hasDataAttrs'))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  ((r = s[n].name),
        ...
        ajax: function(t, n) {
          function r(t, n, r, a) {
            ...
            l ||
              ...
              (S.status = t),
              (S.statusText = (n || T) + ''),
              c ? m.resolveWith(g, [d, T, S]) : m.rejectWith(g, [S, T, p]),
              S.statusCode(x),
              (x = void 0),
              f &&
                v.trigger(c ? 'ajaxSuccess' : 'ajaxError', [S, h, c ? d : p]),
              y.fireWith(g, [S, T]),
              f &&
          ...
          if (h.beforeSend && (h.beforeSend.call(g, S, h) === !1 || l))
            return S.abort();
          if (
            ((T = 'abort'),
            y.add(h.complete),
    ...
    ge.ajaxSetup({
      ...
      ge.each(['top', 'left'], function(e, t) {
        ge.cssHooks[t] = q(pe.pixelPosition, function(e, n) {
          if (n)
            return (n = O(e, t)), at.test(n) ? ge(e).position()[t] + 'px' : n;
        });
      }),
    ...
    return (
      (ge.noConflict = function(t) {
        return (
          e.$ === ge && (e.$ = Qt), t && e.jQuery === ge && (e.jQuery = Ut), ge
        );
      }),
      t || (e.jQuery = e.$ = ge),
      ge
   ...
   */,
      ...
      (e.Pipeline.prototype.run = function(e) {
        for (
          ...
          for (
            var o = e[i], s = 0;
            s < r && ((o = this._stack[s](o, i, e)), void 0 !== o);
            s++
          );
          void 0 !== o && t.push(o);
        }
