 ...
 */,
  (function(e, t) {
    ...
    function a(e) {
      var t = {};
      return (
        ge.each(e.match(Ne) || [], function(e, n) {
          t[n] = !0;
        }),
        t
      );
      ...
      for (var n, r, i = [], o = 0, s = e.length; o < s; o++)
        (r = e[o]),
          r.style &&
            ...
            t
              ? ('none' === n &&
                  ((i[o] = Pe.get(r, 'display') || null),
                  i[o] || (r.style.display = '')),
                '' === r.style.display && _e(r) && (i[o] = v(r)))
    ...
    function b(e, t, n, r, i) {
      ...
      for (f.textContent = '', p = 0; (o = d[p++]); )
        if (r && ge.inArray(o, r) > -1) i && i.push(o);
          ...
          for (l = 0; (o = s[l++]); ) Ye.test(o.type || '') && n.push(o);
      return f;
    }
    function w() {
      return !0;
    ...
    function S(e, t) {
      ...
      if (1 === t.nodeType) {
        ...
        Re.hasData(e) &&
          ((a = Re.access(e)), (u = ge.extend({}, a)), Re.set(t, u));
      }
    }
    function L(e, t) {
    ...
    function D(e, t, r, i) {
      ...
      if (
        ...
        for (a = ge.map(y(o, 'script'), j), u = a.length; f < d; f++)
          (c = o),
            f !== p &&
    ...
    function R(e, t, n, r, i) {
      ...
      for (
        ...
        'margin' === n && (s += ge.css(e, n + Be[o], !0, i)),
          r
            ? ('content' === n && (s -= ge.css(e, 'padding' + Be[o], !0, i)),
              'margin' !== n &&
                (s -= ge.css(e, 'border' + Be[o] + 'Width', !0, i)))
            : ((s += ge.css(e, 'padding' + Be[o], !0, i)),
              'padding' !== n &&
                (s += ge.css(e, 'border' + Be[o] + 'Width', !0, i)));
      return s;
    }
 ...
 */ = (function(
      ...
      (T = t.support = {}),
        ...
        (t.attr = function(e, t) {
          ...
          var n = C.attrHandle[t.toLowerCase()],
            r =
              n && Y.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !F) : void 0;
          return void 0 !== r
            ? r
            : T.attributes || !F
              ? e.getAttribute(t)
        ...
        function(e, t) {
          ge.fn[e] = function(n, r) {
            ...
            return (
              ...
              this.length > 1 &&
                (De[e] || ge.uniqueSort(i), Le.test(e) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
      ...
      ge.extend({
        ...
        ready: function(e) {
          (e === !0 ? --ge.readyWait : ge.isReady) ||
            ((ge.isReady = !0),
            (e !== !0 && --ge.readyWait > 0) || Oe.resolveWith(ne, [ge]));
        }
      }),
      ...
      ge.fn.extend({
        data: function(e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((i = Re.get(o)), 1 === o.nodeType && !Pe.get(o, 'hasDataAttrs'))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  ((r = s[n].name),
        ...
        queue: function(e, t, n) {
          ...
          if (e)
            return (
              ...
              n &&
                (!r || Array.isArray(n)
                  ? (r = Pe.access(e, t, ge.makeArray(n)))
                  : r.push(n)),
              r || []
            );
        },
        ...
        run: function(e) {
          ...
          return (
            this.options.duration
              ? (this.pos = t = ge.easing[this.easing](
                  e,
      ...
      trigger: function(t, n, r, i) {
        ...
        if (
          ...
          if (!i && !f.noBubble && !ge.isWindow(r)) {
            for (
              u = f.delegateType || p, Et.test(u + p) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              d.push(s), (a = s);
        ...
        ge.each({ focus: 'focusin', blur: 'focusout' }, function(e, t) {
          ...
          ge.event.special[t] = {
            ...
            teardown: function() {
              ...
              i
                ? Pe.access(r, t, i)
                : (r.removeEventListener(e, n, !0), Pe.remove(r, t));
            }
          };
        });
    var kt = e.location,
        ...
        ajax: function(t, n) {
          function r(t, n, r, a) {
            ...
            l ||
              ...
              (x = void 0),
              f &&
                v.trigger(c ? 'ajaxSuccess' : 'ajaxError', [C, h, c ? d : p]),
              y.fireWith(g, [C, T]),
              f &&
    ...
    var _t = { 0: 200, 1223: 204 },
      Xt = ge.ajaxSettings.xhr();
    (pe.cors = !!Xt && 'withCredentials' in Xt),
      (pe.ajax = Xt = !!Xt),
      ge.ajaxTransport(function(t) {
        var n, r;
        if (pe.cors || (Xt && !t.crossDomain))
          return {
            send: function(i, o) {
              var s,
                a = t.xhr();
    ...
    ge.ajaxSetup({
      ...
      ge.ajaxPrefilter('json jsonp', function(t, n, r) {
        ...
        if (a || 'jsonp' === t.dataTypes[0])
          return (
            (i = t.jsonpCallback = ge.isFunction(t.jsonpCallback)
              ? t.jsonpCallback()
              : t.jsonpCallback),
            a
      ...
      ge.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function(
        e,
        t
      ) {
        var n = 'pageYOffset' === t;
      ...
      ge.each(['top', 'left'], function(e, t) {
        ge.cssHooks[t] = O(pe.pixelPosition, function(e, n) {
          if (n)
            return (n = q(e, t)), at.test(n) ? ge(e).position()[t] + 'px' : n;
        });
      }),
      ge.each({ Height: 'height', Width: 'width' }, function(e, t) {
        ge.each({ padding: 'inner' + e, content: t, '': 'outer' + e }, function(
          n,
          r
        ) {
    ...
    return (
      (ge.noConflict = function(t) {
        return (
          e.$ === ge && (e.$ = Yt), t && e.jQuery === ge && (e.jQuery = Vt), ge
        );
      }),
      t || (e.jQuery = e.$ = ge),
      ge
  ...
  (function() {
    ...
    function s(t) {
      ...
      i
        ...
        : e(null !== n && jQuery.inArray(n, a) != -1 ? n : a[0]);
    }
    var a = [];
