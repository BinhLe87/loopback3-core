...
async function validateAttributesByItemtypeId(attributesWillCheck, itemTypeId, shouldUseDefaultValue = true) {
    ...
    var validateErrorMessages = __validateInputAttributesWithInDB(attributesWillCheck, attributesInDB, shouldUseDefaultValue);
...
/**
     ...
     */
function __validateInputAttributesWithInDB(attributesWillCheck, attributesInDB, shouldUseDefaultValue) {
    ...
    for (let attributeInDB of attributesInDB) {
        ...
        if (_.isEmpty(sameAttrIds)) {
            throw new Error(`Error: Invalid attributes. The itemtypeId '${attributesInDB.id}' must contain at least one attribute has id '${attributeInDB.id}' as in template`);
        }
        ...
        for (let attrWillCheck of sameAttrIds) {
            ...
            validateErrorMessages = Object.assign(validateErrorMessages, ___validateValuesByJoi(valuesWillValidateByJoi, curJoiSchema, attrWillCheck, attributeInDB, shouldUseDefaultValue));
        }
    }
}
/**
 ...
 */
function ___validateValuesByJoi(valuesWillValidateByJoi, curJoiSchema, attrWillCheck, attributeInDB, shouldUseDefaultValue) {
