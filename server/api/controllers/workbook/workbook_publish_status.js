...
module.exports.workbook_published = async function workbook_published(
  req,
  res,
  next
) {
  ...
  const workbook_status_joi_result = workbook_status_joi.validate(
    req.query,
    validators.baseJoiOptions
  );
